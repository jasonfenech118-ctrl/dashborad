...
urlpatterns = [
    ...
    path("rotation/", views.surgical_rotation, name="surgical_rotation"),
    path("appointments/", views.appointments, name="appointments"),
    path("letters/discharge/", views.discharge_letter, name="discharge_letter"),
    path("letters/gp/", views.gp_letter, name="gp_letter"),
    path("letters/appointment/", views.appointment_letter, name="appointment_letter"),
    path("ordering/", views.ordering_forms, name="ordering_forms"),
    path("ordering/<slug:slug>/", views.ordering_form_detail, name="ordering_form_detail"),
